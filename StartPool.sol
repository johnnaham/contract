...
contract StakeATFearnATFPool is
    Ownable,
    ReentrancyGuard,
    ERC20("Stake ATF earn ATF Pool", "ATF-ATF")
{
    using SafeMath for uint256;

    // The address of the smart chef factory
    address public ATF_CASTLE_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == ATF_CASTLE_FACTORY, "Not factory");
        require(
